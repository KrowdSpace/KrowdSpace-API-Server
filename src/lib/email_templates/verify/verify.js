                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="700px">
                            ...
                            <tr>
                                <td style="font-size: 14px; font-family: Arial;">
                                    <p style="margin: 20px 5px 0px 5px;">Hi ${d.fname},</p>
                                    <p style="margin: 10px 5px;">This message is to confirm that the Krowdspace account with
                                        the username ${d.username} belongs to you. Verifying your email address will provide access to our Krowdspace Dashboard.</p>
                                    <p style="text-align: center; margin: 20px 5px 0px 5px;">Please
                            ...
                            <tr>
                                <td style="font-size: 14px; font-family: Arial; text-align: center;">
                                    <strong><a href="https://www.krowdspace.com/account/verify.html?$verify_code=${d.verify_code}" style="background-color: #fed136; color: #fff; padding: 12px; display:inline-table; border-radius: 5px; margin: 15px 0px 0px 0px;
